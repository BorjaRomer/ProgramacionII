...
/*
 * Clase de interfaz visual para registrar una moto en la BBDD
 */
public class JDialog_AltaMoto extends JDialog implements ActionListener {
	...
	public JDialog_AltaMoto(clsGestor _objGestor, String _operario) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialog_AltaMoto.class.getResource("/Data/icono.png")));
		...
		BotonAtras.setIcon(new ImageIcon(JDialog_AltaMoto.class.getResource("/Data/iconfinder_back_38976.png")));
		...
		BotonGuardar.setIcon(new ImageIcon(JDialog_AltaMoto.class.getResource("/Data/guardar.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(JDialog_AltaMoto.class.getResource("/Data/desguace.jpg")));
