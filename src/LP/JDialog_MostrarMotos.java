...
/*
 * Clase de interfaz gráfica que muestra las motos de la BBDD
 */
public class JDialog_MostrarMotos extends JDialog implements ActionListener {
	...
	public JDialog_MostrarMotos(clsGestor _objGestor, String _operario) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialog_MostrarMotos.class.getResource("/Data/icono.png")));
		...
		botonRecargar.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/recargar.png")));
		...
		internal_venta.setFrameIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/icono.png")));
		...
		btnInVender.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/tick.png")));
		...
		btnInAtras.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/cancelar.png")));
		...
		lblInFondo.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/fondo.jpg")));
		...
		btnAtras.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/iconfinder_back_38976.png")));
		...
		FondoSeparatorUp.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/fondo.jpg")));
		...
		btnEliminar.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/eliminar.png")));
		btnEliminar.setBounds(623, 255, 89, 42);
		contentPane.add(btnEliminar);

		JButton btnVender = new JButton("");
		btnVender.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/vender.png")));
		...
		btnRecambio.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/recambios.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		case CARGAR_TABLA:
			...
			/*
			 * Se crea un nuevo objeto pedido y se cambia el estado de la moto a vendido
			 */
		case BOTON_VENDER:
		...
		case BOTON_INTERNAL_SALIR:
			...
			/*
			 * Cuando una moto se selecciona y se pulsa al boton de vender la ventana JInternalFrame se inicia 
			 */
	...
	public void CrearTabla() {
		...
		FondoSeparatorDown.setIcon(new ImageIcon(JDialog_MostrarMotos.class.getResource("/Data/fondo.jpg")));
