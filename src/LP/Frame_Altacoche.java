...
public class Frame_Altacoche extends JFrame implements ActionListener {
	...
	private JComboBox comb_combustible = new JComboBox();
	private JComboBox comb_estado = new JComboBox();
	private JComboBox comb_tipocoche = new JComboBox();
	...
	public void setComb_combustible(JComboBox comb_combustible) {
		this.comb_combustible = comb_combustible;
	}

	public void setComb_estado(JComboBox comb_estado) {
		this.comb_estado = comb_estado;
	}

	public void setComb_tipocoche(JComboBox comb_tipocoche) {
	...
	public JComboBox getComb_combustible() {
		return comb_combustible;
	}

	public JComboBox getComb_estado() {
		return comb_estado;
	}

	public JComboBox getComb_tipocoche() {
	...
	public Frame_Altacoche() {
		...
		JComboBox comb_combustible = new JComboBox();
		...
		JComboBox comb_tipocoche = new JComboBox();
		...
		JComboBox comb_estado = new JComboBox();
