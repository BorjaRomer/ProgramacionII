...
/**
 * Clase de creacion de conexion de BBDD y gestora de las clases que se encargan de conectar con MySQL *
 */
public class clsDatos {
	...
	public void insertatpedidosBD(double precio, String numbastidor, String dnicliente, String idoperario,
	...
	public ResultSet recogercamionBD() throws SQLException {
		...
		/**
		 * La funcion recoger de la clase CamionBD nos devuelve un ResultSet que
		 * contiene todos los coches que estan en MySQL
		 */
	...
	public void insertarcamionBD(String numbastidor, String marca, String modelo, int cv, Date aniofabricacion,
			Date fecha, String color, int kilometros, int idtipocamion, int altura, int carga, int idestado, int valor,
			String idoperario) throws SQLException {

		// Funcion insertar en la clase CamionBD para hacer una Insert en MySQL*/
		clsCamionBD.insertarBD(numbastidor, marca, modelo, cv, aniofabricacion, fecha, color, kilometros, idtipocamion,
				altura, carga, idestado, valor, idoperario, objConexion);
	}
	...
	/** Insertar moto en BD */
	public void insertarmotoBD(String numbastidor, String marca, String modelo, int cv, Date aniofabricacion,
			Date fecha, String color, int kilometros, int idtipomoto, int cilindrada, String tamaño, int idestado,
			int valor, String idoperario) throws SQLException {

		// Funcion insertar en la clase MotoBD para hacer una Insert en MySQL*/
		clsMotoBD.insertarBD(numbastidor, marca, modelo, cv, aniofabricacion, fecha, color, kilometros, idtipomoto,
				cilindrada, tamaño, idestado, valor, idoperario, objConexion);
	}
	...
	public void insertarcocheBD(String numbastidor, String marca, String modelo, int cv, Date aniofabricacion,
			Date fecha, String color, int kilometros, int idtipocoche, String combustible, int cilindrada, int idestado,
			int valor, String idoperario) throws SQLException {
